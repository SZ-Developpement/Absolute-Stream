...
// Fonction GET pour récupérer les genres d'animes (réutilise la liste des genres TV de TMDB)
export async function GET() {
  ...
  // Construction de l'URL pour l'API TMDB pour les genres TV (utilisés aussi pour les animes)
